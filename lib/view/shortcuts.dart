...
class Shortcutss extends StatefulWidget {
  const Shortcutss({Key? key}) : super(key: key);

  @override
  State<Shortcutss> createState() => _ShortcutssState();
}

class _ShortcutssState extends State<Shortcutss> {
  @override
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Center(
              child: Text("ℹPhotoshop Shortcuts ℹ",
                  style: TextStyle(
