...
class Penels extends StatefulWidget {
  const Penels({Key? key}) : super(key: key);

  @override
  State<Penels> createState() => _PenelsState();
}

class _PenelsState extends State<Penels> {
  @override
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Center(
              child: Text("ℹPhotoshop Panels ℹ",
                  style: TextStyle(
